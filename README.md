# MindSpider - AI驱动的智能舆情爬虫系统

## 项目概述

MindSpider是一个基于Agent技术的智能舆情爬虫系统，通过AI自动识别热点话题，并在多个社交媒体平台进行精准的内容爬取和情感分析。系统采用模块化设计，能够实现从话题发现到内容收集的全自动化流程。

### 核心特性

- **智能话题识别**：基于DeepSeek AI自动分析每日热点新闻，提取关键话题和关键词
- **全平台覆盖**：支持小红书、抖音、快手、B站、微博、贴吧、知乎等7大主流平台
- **自动化工作流**：从新闻采集到话题提取再到内容爬取的全自动化流程
- **情感分析能力**：对爬取内容进行情感分析和舆情监测
- **可扩展架构**：模块化设计，易于扩展新的平台和功能

### 技术架构

- **编程语言**: Python 3.9+
- **AI框架**: DeepSeek API (话题提取与分析)
